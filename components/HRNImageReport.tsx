        ...
        <div ref={ref} className="w-[1000px] bg-white p-1 font-sans text-[11px] leading-tight text-black">
            ...
            <div className="border-[1px] border-black">
                ...
                {data.hazards?.map((hazard: any, index: number) => {
                    ...
                    return (
                        <div key={index} className="grid grid-cols-[12%_13%_10%_10%_10%_10%_8%_12%_15%] text-center border-b-[0.5px] border-black last:border-b-0 min-h-[60px]">
                            {/* Celda Tipo con Título Azul */}
                            <div className="border-r-[0.5px] border-black flex flex-col">
                            ...
                            <div className="p-1 border-r-[0.5px] border-black flex items-center justify-center text-[10px]">
                                {hazard.origin || '-'}
                            </div>
                            ...
                            <div className="flex items-center justify-center font-bold text-[10px] border-r-[0.5px] border-black">
                                {hnr.toFixed(0)}
                            </div>

                            <div className="flex items-center justify-center font-bold text-[10px] border-r-[0.5px] border-black"
                                 style={{ backgroundColor: getRiskColor(hnr) }}>
                                {getRiskText(hnr)}
                            </div>
